...
class home:
    def __init__(self,qq):
        ...
        self.b11=Button(self.d,image= self.photo,borderwidth=0,command= self.call)#text="get all unverified",width=30,height=1,command= self.call )
        #self.b11.config(image=self.photo)
        self.b11.place(x=100,y=25)
        self.b2=Button(self.d,image= self.photo2,borderwidth=0,command= self.caall)#,text="get all unverified of a college",width=30,height=1,command= self.caall)
        self.b3=Button(self.d,image= self.photo3,borderwidth=0,command= self.caaall)#,text="verify a singel student",width=30,height=1,command= self.caaall)
        #self.b11.place(x=100,y=25)
